...
class newGCN(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr=None, batch=None, laplacian_eigenvector_pe=None):
        ...
        print(f"Batch IDs for x: {data.batch[:5]}")
        print(f"Batch IDs for laplacian_eigenvector_pe: {data.batch[:5]}")
...
num_positional_encodings = 9  # Number of Laplacian eigenvectors to use
